...
public static unsafe partial class physx {
    ...
    public static physx.PxRigidDynamicLockFlagsPtr OpPipe_New(physx.PxRigidDynamicLockFlag a, physx.PxRigidDynamicLockFlag b) {
        physx.PxRigidDynamicLockFlag pvk_in_a = a;
        physx.PxRigidDynamicLockFlag pvk_in_b = b;
        return PxRigidDynamicLockFlagsPtr_operator_Ptr_Pipe_PxRigidDynamicLockFlag_PxRigidDynamicLockFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxRigidDynamicLockFlagsPtr OpAnd_New(physx.PxRigidDynamicLockFlag a, physx.PxRigidDynamicLockFlag b) {
        physx.PxRigidDynamicLockFlag pvk_in_a = a;
        physx.PxRigidDynamicLockFlag pvk_in_b = b;
        return PxRigidDynamicLockFlagsPtr_operator_Ptr_Amp_PxRigidDynamicLockFlag_PxRigidDynamicLockFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxRigidDynamicLockFlagsPtr OpTilde_New(physx.PxRigidDynamicLockFlag a) {
        physx.PxRigidDynamicLockFlag pvk_in_a = a;
        return PxRigidDynamicLockFlagsPtr_operator_Ptr_Tilde_PxRigidDynamicLockFlag_(pvk_in_a);
    }
    ...
    public unsafe partial struct PxRigidDynamicPtr : physx.PxRigidBodyPtr.IPxRigidBodyPtr, physx.PxRigidActorPtr.IPxRigidActorPtr, physx.PxActorPtr.IPxActorPtr, physx.PxBasePtr.IPxBasePtr {
        ...
        public void addTorque(physx.PxVec3* torque, physx.PxForceMode mode, bool autowake=true){((physx.PxRigidBodyPtr)this).addTorque(torque, mode, autowake);}
        public void clearForce(physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).clearForce(mode);}
        public void clearTorque(physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).clearTorque(mode);}
        public void setForceAndTorque(physx.PxVec3* force, physx.PxVec3* torque, physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).setForceAndTorque(force, torque, mode);}
        public void setRigidBodyFlag(physx.PxRigidBodyFlag flag, bool value){((physx.PxRigidBodyPtr)this).setRigidBodyFlag(flag, value);}
        ...
        public void addForce(physx.PxVec3 force, physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).addForce((physx.PxVec3*)&force, mode);}
        ...
        public void addForce(physx.PxVec3 force, physx.PxForceMode mode, bool autowake=true){((physx.PxRigidBodyPtr)this).addForce((physx.PxVec3*)&force, mode, autowake);}
        public void addForce(physx.PxVec3.Ref force, physx.PxForceMode mode, bool autowake=true){((physx.PxRigidBodyPtr)this).addForce((physx.PxVec3*)(*((IntPtr*)(&force))), mode, autowake);}
        ...
        public void addTorque(physx.PxVec3 torque, physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).addTorque((physx.PxVec3*)&torque, mode);}
        public void addTorque(physx.PxVec3.Ref torque, physx.PxForceMode mode){((physx.PxRigidBodyPtr)this).addTorque((physx.PxVec3*)(*((IntPtr*)(&torque))), mode);}
