...
public static unsafe partial class physx {
    ...
    public static physx.PxSceneFlagsPtr OpPipe_New(physx.PxSceneFlag a, physx.PxSceneFlag b) {
        physx.PxSceneFlag pvk_in_a = a;
        physx.PxSceneFlag pvk_in_b = b;
        return PxSceneFlagsPtr_operator_Ptr_Pipe_PxSceneFlag_PxSceneFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxSceneFlagsPtr OpAnd_New(physx.PxSceneFlag a, physx.PxSceneFlag b) {
        physx.PxSceneFlag pvk_in_a = a;
        physx.PxSceneFlag pvk_in_b = b;
        return PxSceneFlagsPtr_operator_Ptr_Amp_PxSceneFlag_PxSceneFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxSceneFlagsPtr OpTilde_New(physx.PxSceneFlag a) {
        physx.PxSceneFlag pvk_in_a = a;
        return PxSceneFlagsPtr_operator_Ptr_Tilde_PxSceneFlag_(pvk_in_a);
    }
    ...
    public unsafe partial struct PxSceneDescPtr {
        ...
        public physx.PxPruningStructureType staticStructure {
            get => PxSceneDescPtr_GET_staticStructure(this);
            set => PxSceneDescPtr_SET_staticStructure(this, value);
        }

        public physx.PxPruningStructureType dynamicStructure {
        ...
        public physx.PxSceneQueryUpdateMode sceneQueryUpdateMode {
