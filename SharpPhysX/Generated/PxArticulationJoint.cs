...
public static unsafe partial class physx {
    ...
    public static physx.PxFlags_PxArticulationAxis_bytePtr OpPipe_New(physx.PxArticulationAxis a, physx.PxArticulationAxis b) {
        physx.PxArticulationAxis pvk_in_a = a;
        physx.PxArticulationAxis pvk_in_b = b;
        return PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Pipe_PxArticulationAxis_PxArticulationAxis_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxFlags_PxArticulationAxis_bytePtr OpAnd_New(physx.PxArticulationAxis a, physx.PxArticulationAxis b) {
        physx.PxArticulationAxis pvk_in_a = a;
        physx.PxArticulationAxis pvk_in_b = b;
        return PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Amp_PxArticulationAxis_PxArticulationAxis_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxFlags_PxArticulationAxis_bytePtr OpTilde_New(physx.PxArticulationAxis a) {
        physx.PxArticulationAxis pvk_in_a = a;
        return PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Tilde_PxArticulationAxis_(pvk_in_a);
    }

    public static physx.PxArticulationMotionsPtr OpPipe_New(physx.PxArticulationMotion a, physx.PxArticulationMotion b) {
        physx.PxArticulationMotion pvk_in_a = a;
        physx.PxArticulationMotion pvk_in_b = b;
        return PxArticulationMotionsPtr_operator_Ptr_Pipe_PxArticulationMotion_PxArticulationMotion_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxArticulationMotionsPtr OpAnd_New(physx.PxArticulationMotion a, physx.PxArticulationMotion b) {
        physx.PxArticulationMotion pvk_in_a = a;
        physx.PxArticulationMotion pvk_in_b = b;
        return PxArticulationMotionsPtr_operator_Ptr_Amp_PxArticulationMotion_PxArticulationMotion_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxArticulationMotionsPtr OpTilde_New(physx.PxArticulationMotion a) {
        physx.PxArticulationMotion pvk_in_a = a;
        return PxArticulationMotionsPtr_operator_Ptr_Tilde_PxArticulationMotion_(pvk_in_a);
    }

    public enum PxArticulationJointDriveType : int {
        eTARGET = 0, // eTARGET = 0
        eERROR = 1,  // eERROR = 1
    }
