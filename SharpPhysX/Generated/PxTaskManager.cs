...
public static unsafe partial class physx {
    ...
    public unsafe partial struct PxTaskManagerPtr {
        ...
        public uint submitNamedTask(physx.PxTaskPtr task, string name, physx.PxTaskType type) {
            physx.PxTaskManagerPtr pvk_in_this = this;
            physx.PxTaskPtr pvk_in_task = task;
            string pvk_in_name = name;
            physx.PxTaskType pvk_in_type = type;
            return uint_PxTaskManagerPtr_submitNamedTaskPtr_PxTaskPtr_string_PxTaskType_(pvk_in_this, pvk_in_task, pvk_in_name, pvk_in_type);
        }
