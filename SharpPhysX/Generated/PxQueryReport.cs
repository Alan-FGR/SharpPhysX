...
public static unsafe partial class physx {
    ...
    [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern physx.PxVec3Ptr PxLocationHit_GET_position(PxLocationHitPtr cls);
        
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern void PxLocationHit_SET_position(PxLocationHitPtr cls, physx.PxVec3Ptr value);
        
        public physx.PxVec3Ptr position {
            get => PxLocationHit_GET_position(this);
            set => PxLocationHit_SET_position(this, value);
        }
        
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern physx.PxVec3Ptr PxLocationHit_GET_normal(PxLocationHitPtr cls);
        
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern void PxLocationHit_SET_normal(PxLocationHitPtr cls, physx.PxVec3Ptr value);
