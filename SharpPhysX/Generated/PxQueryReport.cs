...
public static unsafe partial class physx {
    ...
    public static physx.PxHitFlags OpPipe(physx.PxHitFlagEnum a, physx.PxHitFlagEnum b) {
        physx.PxHitFlags RetRef;
        physx.PxHitFlagEnum pvk_in_a = a;
        physx.PxHitFlagEnum pvk_in_b = b;
        PxHitFlags_operator_Ptr_Pipe_PxHitFlagEnum_PxHitFlagEnum_(&RetRef, pvk_in_a, pvk_in_b);
        return RetRef;
    }

    public static physx.PxHitFlags OpAnd(physx.PxHitFlagEnum a, physx.PxHitFlagEnum b) {
        physx.PxHitFlags RetRef;
        physx.PxHitFlagEnum pvk_in_a = a;
        physx.PxHitFlagEnum pvk_in_b = b;
        PxHitFlags_operator_Ptr_Amp_PxHitFlagEnum_PxHitFlagEnum_(&RetRef, pvk_in_a, pvk_in_b);
        return RetRef;
    }

    public static physx.PxHitFlags OpTilde(physx.PxHitFlagEnum a) {
        physx.PxHitFlags RetRef;
        physx.PxHitFlagEnum pvk_in_a = a;
        PxHitFlags_operator_Ptr_Tilde_PxHitFlagEnum_(&RetRef, pvk_in_a);
        return RetRef;
    }
    ...
    public unsafe partial struct PxLocationHitPtr : physx.PxLocationHitPtr.IPxLocationHitPtr, physx.PxQueryHitPtr.IPxQueryHitPtr, physx.PxActorShapePtr.IPxActorShapePtr {
        ...
        public physx.PxHitFlags flags {
            get { physx.PxHitFlags GetRetRef; PxLocationHitPtr_GET_flags(this, &GetRetRef); return GetRetRef; }
        ...
        public unsafe interface IPxLocationHitPtr {
            physx.PxHitFlags flags {get;set;}
