...
public static unsafe partial class physx {
    ...
    [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern physx.PxVec3Ptr physx_PxVec3Ptr_const_physx_PxHeightField_getTriangleNormal_uint_(physx.PxHeightFieldPtr pvk_this, uint pvk_triangleIndex);
        
        public physx.PxVec3Ptr getTriangleNormal_New(uint triangleIndex) {
            physx.PxHeightFieldPtr pvk_in_this = this;
            uint pvk_in_triangleIndex = triangleIndex;
            return physx_PxVec3Ptr_const_physx_PxHeightField_getTriangleNormal_uint_(pvk_in_this, pvk_in_triangleIndex);
        }
