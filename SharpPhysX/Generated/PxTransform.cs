...
public static unsafe partial class physx {
    ...
    public unsafe partial struct PxTransform {
        [FieldOffset( 0)] public physx.PxQuat q;
        [FieldOffset(16)] public physx.PxVec3 p;

        public static PxTransform Default() {

            PxTransform toInit;
            var pvk_in_this = &toInit;
            void_PxTransform_PxTransformPtr_Ctor(pvk_in_this);
            return toInit;
        }
