...
internal static extern physx.PxPairFlagsPtr PxPairFlagsPtr_operator_Ptr_Pipe_PxPairFlag_PxPairFlag_(physx.PxPairFlag pvk_a, physx.PxPairFlag pvk_b);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxPairFlagsPtr PxPairFlagsPtr_operator_Ptr_Amp_PxPairFlag_PxPairFlag_(physx.PxPairFlag pvk_a, physx.PxPairFlag pvk_b);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxPairFlagsPtr PxPairFlagsPtr_operator_Ptr_Tilde_PxPairFlag_(physx.PxPairFlag pvk_a);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxFilterFlagsPtr PxFilterFlagsPtr_operator_Ptr_Pipe_PxFilterFlag_PxFilterFlag_(physx.PxFilterFlag pvk_a, physx.PxFilterFlag pvk_b);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxFilterFlagsPtr PxFilterFlagsPtr_operator_Ptr_Amp_PxFilterFlag_PxFilterFlag_(physx.PxFilterFlag pvk_a, physx.PxFilterFlag pvk_b);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxFilterFlagsPtr PxFilterFlagsPtr_operator_Ptr_Tilde_PxFilterFlag_(physx.PxFilterFlag pvk_a);

[DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
internal static extern physx.PxFilterObjectType PxFilterObjectType_PxGetFilterObjectTypePtr_uint_(uint pvk_attr);
