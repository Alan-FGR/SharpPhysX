...
public partial struct PxQuat {
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern float C_CONST_PxQuat_getAngle(PxQuat cls,PxQuat q);
    public float getAngle(PxQuat q){
        return C_CONST_PxQuat_getAngle(this,q);    
    }
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern PxQuat C_CONST_PxQuat_OP_Minus(PxQuat cls,PxQuat q);
    public static PxQuat operator-(PxQuat cls,PxQuat q){
        return C_CONST_PxQuat_OP_Minus(cls,q);    
    }

    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern PxQuat C_CONST_PxQuat_OP_Star(PxQuat cls,float r);
    public static PxQuat Star(PxQuat cls,float r){
        return C_CONST_PxQuat_OP_Star(cls,r);    
    }
