...
public partial struct PxVec3 { // blittable
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern PxVec3 C_PxVec3_PxVec3_2(float nx,float ny,float nz);
    public unsafe PxVec3(float nx,float ny,float nz){
        var _new = C_PxVec3_PxVec3_2(nx,ny,nz);        
        fixed (void* ptr = &this)
          Buffer.MemoryCopy(&_new, ptr, Marshal.SizeOf(this), Marshal.SizeOf(this));    
    }

    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern PxVec3 C_PxVec3_PxVec3_3(PxVec3 v);
    public unsafe PxVec3(PxVec3 v){
        var _new = C_PxVec3_PxVec3_3(v);        
        fixed (void* ptr = &this)
          Buffer.MemoryCopy(&_new, ptr, Marshal.SizeOf(this), Marshal.SizeOf(this));    
    }
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern PxVec3 C_CONST_PxVec3_OP_Minus_2(PxVec3 cls,PxVec3 v);
    public static PxVec3 operator-(PxVec3 cls,PxVec3 v){
        return C_CONST_PxVec3_OP_Minus_2(cls,v);    
    }
