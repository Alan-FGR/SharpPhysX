...
public static unsafe partial class physx {
    ...
    [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern physx.PxBounds3Ptr PxBroadPhaseRegion_GET_bounds(PxBroadPhaseRegionPtr cls);
        
        [DllImport(SharpPhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern void PxBroadPhaseRegion_SET_bounds(PxBroadPhaseRegionPtr cls, physx.PxBounds3Ptr value);
        
        public physx.PxBounds3Ptr bounds {
            get => PxBroadPhaseRegion_GET_bounds(this);
