...
public static unsafe partial class physx {
    ...
    public unsafe partial struct PxQueryFilterCallbackPtr {
        ...
        public physx.PxQueryHitTypeEnum preFilter(physx.PxFilterDataPtr filterData, physx.PxShapePtr shape, physx.PxRigidActorPtr actor, physx.PxHitFlags* queryFlags) {
            ...
            return PxQueryHitTypeEnum_PxQueryFilterCallbackPtr_preFilterPtr_PxFilterDataPtr_PxShapePtr_PxRigidActorPtr_PxHitFlags_(pvk_in_this, pvk_in_filterData, pvk_in_shape, pvk_in_actor, pvk_in_queryFlags);
        }
        ...
        public physx.PxQueryHitTypeEnum preFilter(physx.PxFilterDataPtr filterData, physx.PxShapePtr shape, physx.PxRigidActorPtr actor, physx.PxHitFlags queryFlags) {
            return preFilter(filterData, shape, actor, (physx.PxHitFlags*)&queryFlags);
        }

        public physx.PxQueryHitTypeEnum preFilter(physx.PxFilterDataPtr filterData, physx.PxShapePtr shape, physx.PxRigidActorPtr actor, physx.PxHitFlags.Ref queryFlags) {
            return preFilter(filterData, shape, actor, (physx.PxHitFlags*)(*((IntPtr*)(&queryFlags))));
        }
    }
