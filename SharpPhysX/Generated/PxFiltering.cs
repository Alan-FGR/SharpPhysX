...
public static unsafe partial class physx {
    ...
    public static physx.PxPairFlagsPtr OpPipe_New(physx.PxPairFlag a, physx.PxPairFlag b) {
        physx.PxPairFlag pvk_in_a = a;
        physx.PxPairFlag pvk_in_b = b;
        return PxPairFlagsPtr_operator_Ptr_Pipe_PxPairFlag_PxPairFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxPairFlagsPtr OpAnd_New(physx.PxPairFlag a, physx.PxPairFlag b) {
        physx.PxPairFlag pvk_in_a = a;
        physx.PxPairFlag pvk_in_b = b;
        return PxPairFlagsPtr_operator_Ptr_Amp_PxPairFlag_PxPairFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxPairFlagsPtr OpTilde_New(physx.PxPairFlag a) {
        physx.PxPairFlag pvk_in_a = a;
        return PxPairFlagsPtr_operator_Ptr_Tilde_PxPairFlag_(pvk_in_a);
    }

    public static physx.PxFilterFlagsPtr OpPipe_New(physx.PxFilterFlag a, physx.PxFilterFlag b) {
        physx.PxFilterFlag pvk_in_a = a;
        physx.PxFilterFlag pvk_in_b = b;
        return PxFilterFlagsPtr_operator_Ptr_Pipe_PxFilterFlag_PxFilterFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxFilterFlagsPtr OpAnd_New(physx.PxFilterFlag a, physx.PxFilterFlag b) {
        physx.PxFilterFlag pvk_in_a = a;
        physx.PxFilterFlag pvk_in_b = b;
        return PxFilterFlagsPtr_operator_Ptr_Amp_PxFilterFlag_PxFilterFlag_(pvk_in_a, pvk_in_b);
    }

    public static physx.PxFilterFlagsPtr OpTilde_New(physx.PxFilterFlag a) {
        physx.PxFilterFlag pvk_in_a = a;
        return PxFilterFlagsPtr_operator_Ptr_Tilde_PxFilterFlag_(pvk_in_a);
    }

    public static physx.PxFilterObjectType PxGetFilterObjectType(uint attr) {
        uint pvk_in_attr = attr;
        return PxFilterObjectType_PxGetFilterObjectTypePtr_uint_(pvk_in_attr);
    }
