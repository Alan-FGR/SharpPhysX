...
public static partial class physx{
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxAbs_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern int C_PxAbs_3(int a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxSqrt_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxRecipSqrt_2(double a);
    public static double PxRecipSqrt(double a){
        return C_PxRecipSqrt_2(a);    
    }
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxSin_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxCos_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxTan_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxAsin_2(double f);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxAcos_2(double f);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxAtan_2(double a);
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern double C_PxAtan2_2(double x,double y);
    public static double PxAtan2(double x,double y){
        return C_PxAtan2_2(x,y);    
    }
    ...
    [DllImport(PhysX.Lib, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern bool C_PxIsFinite_2(double f);
    public static bool PxIsFinite(double f){
        return C_PxIsFinite_2(f);    
    }
