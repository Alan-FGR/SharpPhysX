...
ES physx::PxPlane C_PxPlane_PxPlane_2(physx::PxVec3* normal,float distance){ // L70

    return physx::PxPlane::PxPlane(normal,distance);
};

ES physx::PxPlane C_PxPlane_PxPlane_3(physx::PxVec3* point,physx::PxVec3* normal){ // L77

    return physx::PxPlane::PxPlane(point,normal);
};

ES physx::PxPlane C_PxPlane_PxPlane_4(physx::PxVec3* p0,physx::PxVec3* p1,physx::PxVec3* p2){ // L85
