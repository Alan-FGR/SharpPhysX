...
ES PxBaseFlagsPtr PxBaseFlagsPtr_operator_Ptr_Pipe_PxBaseFlag_PxBaseFlag_(physx::PxBaseFlag::Enum wrp_a, physx::PxBaseFlag::Enum wrp_b){
...
ES PxBaseFlagsPtr PxBaseFlagsPtr_operator_Ptr_Amp_PxBaseFlag_PxBaseFlag_(physx::PxBaseFlag::Enum wrp_a, physx::PxBaseFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxBaseFlags];
    std::memcpy(heap, &ret, sizeof PxBaseFlags);
    return (PxBaseFlagsPtr) heap;
...
ES PxBaseFlagsPtr PxBaseFlagsPtr_operator_Ptr_Tilde_PxBaseFlag_(physx::PxBaseFlag::Enum wrp_a){
...
ES void void_PxBasePtr_setBaseFlagPtr_PxBaseFlag_bool_(PxBasePtr wrp_this, physx::PxBaseFlag::Enum wrp_flag, bool wrp_value){
