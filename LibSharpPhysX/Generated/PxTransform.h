...
ES physx::PxTransform C_PxTransform_PxTransform_2(physx::PxQuat* orientation){ // L67

    return physx::PxTransform::PxTransform(orientation);
};

ES physx::PxTransform C_PxTransform_PxTransform_3(float x,float y,float z,physx::PxQuat aQ){ // L72

    return physx::PxTransform::PxTransform(x,y,z,aQ);
};

ES physx::PxTransform C_PxTransform_PxTransform_4(physx::PxVec3* p0,physx::PxQuat* q0){ // L77

    return physx::PxTransform::PxTransform(p0,q0);
};

ES physx::PxTransform C_PxTransform_PxTransform_5(physx::PxMat44* m){ // L82
...
ES physx::PxTransform C_CONST_PxTransform_transform_2(physx::PxTransform cls,physx::PxTransform* src){ // L136
...
ES physx::PxTransform C_CONST_PxTransform_transformInv_2(physx::PxTransform cls,physx::PxTransform* src){ // L172

    return cls.transformInv(src);
};

ES physx::PxPlane C_CONST_PxTransform_transform_3(physx::PxTransform cls,physx::PxPlane* plane){ // L185
