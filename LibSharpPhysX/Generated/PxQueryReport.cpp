...
ES void PxHitFlags_operator_Ptr_Pipe_PxHitFlagEnum_PxHitFlagEnum_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a, physx::PxHitFlag::Enum wrp_b){
    *nRetRef = ::physx::operator|(wrp_a, wrp_b);
}

ES void PxHitFlags_operator_Ptr_Amp_PxHitFlagEnum_PxHitFlagEnum_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a, physx::PxHitFlag::Enum wrp_b){
    *nRetRef = ::physx::operator&(wrp_a, wrp_b);
}

ES void PxHitFlags_operator_Ptr_Tilde_PxHitFlagEnum_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a){
    *nRetRef = ::physx::operator~(wrp_a);
}
...
ES void PxLocationHitPtr_GET_flags(PxLocationHitPtr cls, PxHitFlags* GetRetRef) {*GetRetRef = cls->flags;}
ES void PxLocationHitPtr_SET_flags(PxLocationHitPtr cls, PxHitFlags value) {cls->flags = value;}
