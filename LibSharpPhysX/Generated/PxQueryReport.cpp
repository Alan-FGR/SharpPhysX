...
ES PxVec3Ptr PxLocationHit_GET_position(PxLocationHitPtr cls) {return (PxVec3Ptr)&cls->position;}
ES void PxLocationHit_SET_position(PxLocationHitPtr cls, PxVec3Ptr value) {cls->position = *value;}

ES PxVec3Ptr PxLocationHit_GET_normal(PxLocationHitPtr cls) {return (PxVec3Ptr)&cls->normal;}
ES void PxLocationHit_SET_normal(PxLocationHitPtr cls, PxVec3Ptr value) {cls->normal = *value;}
