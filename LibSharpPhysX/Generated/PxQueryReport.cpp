...
ES void PxHitFlags_operator_Ptr_Pipe_PxHitFlag_PxHitFlag_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a, physx::PxHitFlag::Enum wrp_b){
    *nRetRef = ::physx::operator|(wrp_a, wrp_b);
}

ES void PxHitFlags_operator_Ptr_Amp_PxHitFlag_PxHitFlag_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a, physx::PxHitFlag::Enum wrp_b){
    *nRetRef = ::physx::operator&(wrp_a, wrp_b);
}

ES void PxHitFlags_operator_Ptr_Tilde_PxHitFlag_(PxHitFlags* nRetRef, physx::PxHitFlag::Enum wrp_a){
