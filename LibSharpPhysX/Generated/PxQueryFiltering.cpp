...
ES PxQueryFlagsPtr PxQueryFlagsPtr_operator_Ptr_Pipe_PxQueryFlag_PxQueryFlag_(physx::PxQueryFlag::Enum wrp_a, physx::PxQueryFlag::Enum wrp_b){
...
ES PxQueryFlagsPtr PxQueryFlagsPtr_operator_Ptr_Amp_PxQueryFlag_PxQueryFlag_(physx::PxQueryFlag::Enum wrp_a, physx::PxQueryFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxQueryFlags];
    std::memcpy(heap, &ret, sizeof PxQueryFlags);
    return (PxQueryFlagsPtr) heap;
...
ES PxQueryFlagsPtr PxQueryFlagsPtr_operator_Ptr_Tilde_PxQueryFlag_(physx::PxQueryFlag::Enum wrp_a){
...
ES physx::PxQueryHitType::Enum PxQueryHitType_PxQueryFilterCallbackPtr_preFilterPtr_PxFilterDataPtr_PxShapePtr_PxRigidActorPtr_PxHitFlags_(PxQueryFilterCallbackPtr wrp_this, PxFilterDataPtr wrp_filterData, PxShapePtr wrp_shape, PxRigidActorPtr wrp_actor, PxHitFlags* wrp_queryFlags){
    return (physx::PxQueryHitType::Enum) wrp_this->preFilter(*wrp_filterData, wrp_shape, wrp_actor, *wrp_queryFlags);
}

ES physx::PxQueryHitType::Enum PxQueryHitType_PxQueryFilterCallbackPtr_postFilterPtr_PxFilterDataPtr_PxQueryHitPtr_(PxQueryFilterCallbackPtr wrp_this, PxFilterDataPtr wrp_filterData, PxQueryHitPtr wrp_hit){
