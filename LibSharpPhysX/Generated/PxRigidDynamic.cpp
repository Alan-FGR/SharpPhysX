...
ES PxRigidDynamicLockFlagsPtr PxRigidDynamicLockFlagsPtr_operator_Ptr_Pipe_PxRigidDynamicLockFlag_PxRigidDynamicLockFlag_(physx::PxRigidDynamicLockFlag::Enum wrp_a, physx::PxRigidDynamicLockFlag::Enum wrp_b){
...
ES PxRigidDynamicLockFlagsPtr PxRigidDynamicLockFlagsPtr_operator_Ptr_Amp_PxRigidDynamicLockFlag_PxRigidDynamicLockFlag_(physx::PxRigidDynamicLockFlag::Enum wrp_a, physx::PxRigidDynamicLockFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxRigidDynamicLockFlags];
    std::memcpy(heap, &ret, sizeof PxRigidDynamicLockFlags);
    return (PxRigidDynamicLockFlagsPtr) heap;
...
ES PxRigidDynamicLockFlagsPtr PxRigidDynamicLockFlagsPtr_operator_Ptr_Tilde_PxRigidDynamicLockFlag_(physx::PxRigidDynamicLockFlag::Enum wrp_a){
...
ES void void_PxRigidDynamicPtr_setRigidDynamicLockFlagPtr_PxRigidDynamicLockFlag_bool_(PxRigidDynamicPtr wrp_this, physx::PxRigidDynamicLockFlag::Enum wrp_flag, bool wrp_value){
