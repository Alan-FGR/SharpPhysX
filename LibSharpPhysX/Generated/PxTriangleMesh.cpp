...
ES PxTriangleMeshFlagsPtr PxTriangleMeshFlagsPtr_operator_Ptr_Pipe_PxTriangleMeshFlag_PxTriangleMeshFlag_(physx::PxTriangleMeshFlag::Enum wrp_a, physx::PxTriangleMeshFlag::Enum wrp_b){
...
ES PxTriangleMeshFlagsPtr PxTriangleMeshFlagsPtr_operator_Ptr_Amp_PxTriangleMeshFlag_PxTriangleMeshFlag_(physx::PxTriangleMeshFlag::Enum wrp_a, physx::PxTriangleMeshFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxTriangleMeshFlags];
    std::memcpy(heap, &ret, sizeof PxTriangleMeshFlags);
    return (PxTriangleMeshFlagsPtr) heap;
...
ES PxTriangleMeshFlagsPtr PxTriangleMeshFlagsPtr_operator_Ptr_Tilde_PxTriangleMeshFlag_(physx::PxTriangleMeshFlag::Enum wrp_a){
