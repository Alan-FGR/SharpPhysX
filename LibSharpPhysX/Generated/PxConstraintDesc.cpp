...
ES PxVec3Ptr Px1DConstraint_GET_linear0(Px1DConstraintPtr cls) {return (PxVec3Ptr)&cls->linear0;}
ES void Px1DConstraint_SET_linear0(Px1DConstraintPtr cls, PxVec3Ptr value) {cls->linear0 = *value;}
...
ES PxVec3Ptr Px1DConstraint_GET_angular0(Px1DConstraintPtr cls) {return (PxVec3Ptr)&cls->angular0;}
ES void Px1DConstraint_SET_angular0(Px1DConstraintPtr cls, PxVec3Ptr value) {cls->angular0 = *value;}
...
ES PxVec3Ptr Px1DConstraint_GET_linear1(Px1DConstraintPtr cls) {return (PxVec3Ptr)&cls->linear1;}
ES void Px1DConstraint_SET_linear1(Px1DConstraintPtr cls, PxVec3Ptr value) {cls->linear1 = *value;}
...
ES PxVec3Ptr Px1DConstraint_GET_angular1(Px1DConstraintPtr cls) {return (PxVec3Ptr)&cls->angular1;}
ES void Px1DConstraint_SET_angular1(Px1DConstraintPtr cls, PxVec3Ptr value) {cls->angular1 = *value;}
...
ES void void_physx_PxConstraintVisualizer_visualizeJointFrames_physx_PxTransformPtr_physx_PxTransformPtr_(PxConstraintVisualizerPtr wrp_this, PxTransformPtr wrp_parent, PxTransformPtr wrp_child){
    wrp_this->visualizeJointFrames(*wrp_parent, *wrp_child);
}

ES void void_physx_PxConstraintVisualizer_visualizeLinearLimit_physx_PxTransformPtr_physx_PxTransformPtr_float_bool_(PxConstraintVisualizerPtr wrp_this, PxTransformPtr wrp_t0, PxTransformPtr wrp_t1, float wrp_value, bool wrp_active){
    wrp_this->visualizeLinearLimit(*wrp_t0, *wrp_t1, wrp_value, wrp_active);
}

ES void void_physx_PxConstraintVisualizer_visualizeAngularLimit_physx_PxTransformPtr_float_float_bool_(PxConstraintVisualizerPtr wrp_this, PxTransformPtr wrp_t0, float wrp_lower, float wrp_upper, bool wrp_active){
    wrp_this->visualizeAngularLimit(*wrp_t0, wrp_lower, wrp_upper, wrp_active);
}

ES void void_physx_PxConstraintVisualizer_visualizeLimitCone_physx_PxTransformPtr_float_float_bool_(PxConstraintVisualizerPtr wrp_this, PxTransformPtr wrp_t, float wrp_tanQSwingY, float wrp_tanQSwingZ, bool wrp_active){
    wrp_this->visualizeLimitCone(*wrp_t, wrp_tanQSwingY, wrp_tanQSwingZ, wrp_active);
}

ES void void_physx_PxConstraintVisualizer_visualizeDoubleCone_physx_PxTransformPtr_float_bool_(PxConstraintVisualizerPtr wrp_this, PxTransformPtr wrp_t, float wrp_angle, bool wrp_active){
    wrp_this->visualizeDoubleCone(*wrp_t, wrp_angle, wrp_active);
}

ES void void_physx_PxConstraintVisualizer_visualizeLine_physx_PxVec3Ptr_physx_PxVec3Ptr_uint_(PxConstraintVisualizerPtr wrp_this, PxVec3Ptr wrp_p0, PxVec3Ptr wrp_p1, unsigned int wrp_color){
...
ES void void_physx_PxConstraintConnector_onOriginShift_physx_PxVec3Ptr_(PxConstraintConnectorPtr wrp_this, PxVec3Ptr wrp_shift){
