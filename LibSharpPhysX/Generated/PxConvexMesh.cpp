...
ES PxVec3Ptr physx_PxVec3Ptr_const_physx_PxConvexMesh_getVertices(PxConvexMeshPtr wrp_this){
...
ES void void_const_physx_PxConvexMesh_getMassInformation_float_physx_PxMat33Ptr_physx_PxVec3Ptr_(PxConvexMeshPtr wrp_this, float* wrp_mass, PxMat33Ptr wrp_localInertia, PxVec3Ptr wrp_localCenterOfMass){
    wrp_this->getMassInformation(*wrp_mass, *wrp_localInertia, *wrp_localCenterOfMass);
}

ES PxBounds3Ptr physx_PxBounds3Ptr_const_physx_PxConvexMesh_getLocalBounds(PxConvexMeshPtr wrp_this){
