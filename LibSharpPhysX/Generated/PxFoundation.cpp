...
ES void void_PxFoundationPtr_setErrorLevelPtr_PxErrorCode_(PxFoundationPtr wrp_this, physx::PxErrorCode::Enum wrp_mask){
    wrp_this->setErrorLevel(wrp_mask);
}

ES physx::PxErrorCode::Enum PxErrorCode_const_PxFoundationPtr_getErrorLevelPtr(PxFoundationPtr wrp_this){
