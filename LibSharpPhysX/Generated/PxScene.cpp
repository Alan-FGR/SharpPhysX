...
ES PxActorTypeFlagsPtr PxActorTypeFlagsPtr_operator_Ptr_Pipe_PxActorTypeFlag_PxActorTypeFlag_(physx::PxActorTypeFlag::Enum wrp_a, physx::PxActorTypeFlag::Enum wrp_b){
...
ES PxActorTypeFlagsPtr PxActorTypeFlagsPtr_operator_Ptr_Amp_PxActorTypeFlag_PxActorTypeFlag_(physx::PxActorTypeFlag::Enum wrp_a, physx::PxActorTypeFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxActorTypeFlags];
    std::memcpy(heap, &ret, sizeof PxActorTypeFlags);
    return (PxActorTypeFlagsPtr) heap;
...
ES PxActorTypeFlagsPtr PxActorTypeFlagsPtr_operator_Ptr_Tilde_PxActorTypeFlag_(physx::PxActorTypeFlag::Enum wrp_a){
...
ES void void_PxScenePtr_setFlagPtr_PxSceneFlag_bool_(PxScenePtr wrp_this, physx::PxSceneFlag::Enum wrp_flag, bool wrp_value){
...
ES void void_PxScenePtr_setFrictionTypePtr_PxFrictionType_(PxScenePtr wrp_this, physx::PxFrictionType::Enum wrp_frictionType){
    wrp_this->setFrictionType(wrp_frictionType);
}

ES physx::PxFrictionType::Enum PxFrictionType_const_PxScenePtr_getFrictionTypePtr(PxScenePtr wrp_this){
    return (physx::PxFrictionType::Enum) wrp_this->getFrictionType();
}

ES bool bool_PxScenePtr_setVisualizationParameterPtr_PxVisualizationParameter_float_(PxScenePtr wrp_this, physx::PxVisualizationParameter::Enum wrp_param, PxReal wrp_value){
    return (bool) wrp_this->setVisualizationParameter(wrp_param, wrp_value);
}

ES PxReal float_const_PxScenePtr_getVisualizationParameterPtr_PxVisualizationParameter_(PxScenePtr wrp_this, physx::PxVisualizationParameter::Enum wrp_paramEnum){
...
ES physx::PxPruningStructureType::Enum PxPruningStructureType_const_PxScenePtr_getStaticStructurePtr(PxScenePtr wrp_this){
    return (physx::PxPruningStructureType::Enum) wrp_this->getStaticStructure();
}

ES physx::PxPruningStructureType::Enum PxPruningStructureType_const_PxScenePtr_getDynamicStructurePtr(PxScenePtr wrp_this){
...
ES void void_PxScenePtr_setSceneQueryUpdateModePtr_PxSceneQueryUpdateMode_(PxScenePtr wrp_this, physx::PxSceneQueryUpdateMode::Enum wrp_updateMode){
    wrp_this->setSceneQueryUpdateMode(wrp_updateMode);
}

ES physx::PxSceneQueryUpdateMode::Enum PxSceneQueryUpdateMode_const_PxScenePtr_getSceneQueryUpdateModePtr(PxScenePtr wrp_this){
...
ES physx::PxBroadPhaseType::Enum PxBroadPhaseType_const_PxScenePtr_getBroadPhaseTypePtr(PxScenePtr wrp_this){
