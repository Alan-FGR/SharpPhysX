...
ES void void_PxGetFilterOpsPtr_PxFilterOp_PxFilterOp_PxFilterOp_(physx::PxFilterOp::Enum* wrp_op0, physx::PxFilterOp::Enum* wrp_op1, physx::PxFilterOp::Enum* wrp_op2){
    ::physx::PxGetFilterOps(*wrp_op0, *wrp_op1, *wrp_op2);
}

ES void void_PxSetFilterOpsPtr_PxFilterOp_PxFilterOp_PxFilterOp_(physx::PxFilterOp::Enum* wrp_op0, physx::PxFilterOp::Enum* wrp_op1, physx::PxFilterOp::Enum* wrp_op2){
