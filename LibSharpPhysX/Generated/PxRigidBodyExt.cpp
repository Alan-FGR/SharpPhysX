...
ES void void_PxRigidBodyExtPtr_addForceAtPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode, bool wrp_wakeup){
    ::physx::PxRigidBodyExt::addForceAtPos(*wrp_body, *wrp_force, *wrp_pos, wrp_mode, wrp_wakeup);
}

ES void void_PxRigidBodyExtPtr_addForceAtLocalPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode, bool wrp_wakeup){
    ::physx::PxRigidBodyExt::addForceAtLocalPos(*wrp_body, *wrp_force, *wrp_pos, wrp_mode, wrp_wakeup);
}

ES void void_PxRigidBodyExtPtr_addLocalForceAtPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode, bool wrp_wakeup){
    ::physx::PxRigidBodyExt::addLocalForceAtPos(*wrp_body, *wrp_force, *wrp_pos, wrp_mode, wrp_wakeup);
}

ES void void_PxRigidBodyExtPtr_addLocalForceAtLocalPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode, bool wrp_wakeup){
...
ES bool bool_PxRigidBodyExtPtr_linearSweepSinglePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_PxQueryCachePtr_float_C_C(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_closestHit, PxU32* wrp_shapeIndex, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall, PxQueryCachePtr wrp_cache, PxReal wrp_inflation){
    return (bool) ::physx::PxRigidBodyExt::linearSweepSingle(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, *wrp_closestHit, *wrp_shapeIndex, *wrp_filterData, wrp_filterCall, wrp_cache, wrp_inflation);
}

ES PxU32 uint_PxRigidBodyExtPtr_linearSweepMultiplePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_uint_PxSweepHitPtr_int_bool_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_PxQueryCachePtr_float_C_C(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_touchHitBuffer, PxU32* wrp_touchHitShapeIndices, PxU32 wrp_touchHitBufferSize, PxSweepHitPtr wrp_block, PxI32* wrp_blockingShapeIndex, bool* wrp_overflow, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall, PxQueryCachePtr wrp_cache, PxReal wrp_inflation){
    return (PxU32) ::physx::PxRigidBodyExt::linearSweepMultiple(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, wrp_touchHitBuffer, wrp_touchHitShapeIndices, wrp_touchHitBufferSize, *wrp_block, *wrp_blockingShapeIndex, *wrp_overflow, *wrp_filterData, wrp_filterCall, wrp_cache, wrp_inflation);
}
...
ES void void_PxRigidBodyExtPtr_addForceAtPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode){
...
ES void void_PxRigidBodyExtPtr_addForceAtLocalPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode){
...
ES void void_PxRigidBodyExtPtr_addLocalForceAtPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode){
...
ES void void_PxRigidBodyExtPtr_addLocalForceAtLocalPosPtr_PxRigidBodyPtr_PxVec3_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_body, physx::PxVec3* wrp_force, physx::PxVec3* wrp_pos, physx::PxForceMode::Enum wrp_mode){
    ::physx::PxRigidBodyExt::addLocalForceAtLocalPos(*wrp_body, *wrp_force, *wrp_pos, wrp_mode);
}

ES bool bool_PxRigidBodyExtPtr_linearSweepSinglePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_closestHit, PxU32* wrp_shapeIndex){
    return (bool) ::physx::PxRigidBodyExt::linearSweepSingle(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, *wrp_closestHit, *wrp_shapeIndex);
}

ES bool bool_PxRigidBodyExtPtr_linearSweepSinglePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_PxQueryFilterDataPtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_closestHit, PxU32* wrp_shapeIndex, PxQueryFilterDataPtr wrp_filterData){
    return (bool) ::physx::PxRigidBodyExt::linearSweepSingle(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, *wrp_closestHit, *wrp_shapeIndex, *wrp_filterData);
}

ES bool bool_PxRigidBodyExtPtr_linearSweepSinglePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_closestHit, PxU32* wrp_shapeIndex, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall){
    return (bool) ::physx::PxRigidBodyExt::linearSweepSingle(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, *wrp_closestHit, *wrp_shapeIndex, *wrp_filterData, wrp_filterCall);
}

ES bool bool_PxRigidBodyExtPtr_linearSweepSinglePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_PxQueryCachePtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_closestHit, PxU32* wrp_shapeIndex, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall, PxQueryCachePtr wrp_cache){
    return (bool) ::physx::PxRigidBodyExt::linearSweepSingle(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, *wrp_closestHit, *wrp_shapeIndex, *wrp_filterData, wrp_filterCall, wrp_cache);
}

ES PxU32 uint_PxRigidBodyExtPtr_linearSweepMultiplePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_uint_PxSweepHitPtr_int_bool_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_touchHitBuffer, PxU32* wrp_touchHitShapeIndices, PxU32 wrp_touchHitBufferSize, PxSweepHitPtr wrp_block, PxI32* wrp_blockingShapeIndex, bool* wrp_overflow){
    return (PxU32) ::physx::PxRigidBodyExt::linearSweepMultiple(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, wrp_touchHitBuffer, wrp_touchHitShapeIndices, wrp_touchHitBufferSize, *wrp_block, *wrp_blockingShapeIndex, *wrp_overflow);
}

ES PxU32 uint_PxRigidBodyExtPtr_linearSweepMultiplePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_uint_PxSweepHitPtr_int_bool_PxQueryFilterDataPtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_touchHitBuffer, PxU32* wrp_touchHitShapeIndices, PxU32 wrp_touchHitBufferSize, PxSweepHitPtr wrp_block, PxI32* wrp_blockingShapeIndex, bool* wrp_overflow, PxQueryFilterDataPtr wrp_filterData){
    return (PxU32) ::physx::PxRigidBodyExt::linearSweepMultiple(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, wrp_touchHitBuffer, wrp_touchHitShapeIndices, wrp_touchHitBufferSize, *wrp_block, *wrp_blockingShapeIndex, *wrp_overflow, *wrp_filterData);
}

ES PxU32 uint_PxRigidBodyExtPtr_linearSweepMultiplePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_uint_PxSweepHitPtr_int_bool_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_touchHitBuffer, PxU32* wrp_touchHitShapeIndices, PxU32 wrp_touchHitBufferSize, PxSweepHitPtr wrp_block, PxI32* wrp_blockingShapeIndex, bool* wrp_overflow, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall){
    return (PxU32) ::physx::PxRigidBodyExt::linearSweepMultiple(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, wrp_touchHitBuffer, wrp_touchHitShapeIndices, wrp_touchHitBufferSize, *wrp_block, *wrp_blockingShapeIndex, *wrp_overflow, *wrp_filterData, wrp_filterCall);
}

ES PxU32 uint_PxRigidBodyExtPtr_linearSweepMultiplePtr_PxRigidBodyPtr_PxScenePtr_PxVec3_float_PxHitFlags_PxSweepHitPtr_uint_uint_PxSweepHitPtr_int_bool_PxQueryFilterDataPtr_PxQueryFilterCallbackPtr_PxQueryCachePtr_C_(PxRigidBodyPtr wrp_body, PxScenePtr wrp_scene, physx::PxVec3* wrp_unitDir, PxReal wrp_distance, char wrp_outputFlags[sizeof(PxHitFlags)], PxSweepHitPtr wrp_touchHitBuffer, PxU32* wrp_touchHitShapeIndices, PxU32 wrp_touchHitBufferSize, PxSweepHitPtr wrp_block, PxI32* wrp_blockingShapeIndex, bool* wrp_overflow, PxQueryFilterDataPtr wrp_filterData, PxQueryFilterCallbackPtr wrp_filterCall, PxQueryCachePtr wrp_cache){
    return (PxU32) ::physx::PxRigidBodyExt::linearSweepMultiple(*wrp_body, *wrp_scene, *wrp_unitDir, wrp_distance, *(PxHitFlags*)&wrp_outputFlags, wrp_touchHitBuffer, wrp_touchHitShapeIndices, wrp_touchHitBufferSize, *wrp_block, *wrp_blockingShapeIndex, *wrp_overflow, *wrp_filterData, wrp_filterCall, wrp_cache);
}
