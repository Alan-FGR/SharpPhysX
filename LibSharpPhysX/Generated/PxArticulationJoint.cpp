...
ES PxFlags_PxArticulationAxis_bytePtr PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Pipe_PxArticulationAxis_PxArticulationAxis_(physx::PxArticulationAxis::Enum wrp_a, physx::PxArticulationAxis::Enum wrp_b){
...
ES PxFlags_PxArticulationAxis_bytePtr PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Amp_PxArticulationAxis_PxArticulationAxis_(physx::PxArticulationAxis::Enum wrp_a, physx::PxArticulationAxis::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxFlags<physx::PxArticulationAxis::Enum, unsigned char>];
    std::memcpy(heap, &ret, sizeof PxFlags<physx::PxArticulationAxis::Enum, unsigned char>);
    return (PxFlags_PxArticulationAxis_bytePtr) heap;
...
ES PxFlags_PxArticulationAxis_bytePtr PxFlags_PxArticulationAxis_bytePtr_operator_Ptr_Tilde_PxArticulationAxis_(physx::PxArticulationAxis::Enum wrp_a){
...
ES PxArticulationMotionsPtr PxArticulationMotionsPtr_operator_Ptr_Pipe_PxArticulationMotion_PxArticulationMotion_(physx::PxArticulationMotion::Enum wrp_a, physx::PxArticulationMotion::Enum wrp_b){
    auto ret = ::physx::operator|(wrp_a, wrp_b);
...
ES PxArticulationMotionsPtr PxArticulationMotionsPtr_operator_Ptr_Amp_PxArticulationMotion_PxArticulationMotion_(physx::PxArticulationMotion::Enum wrp_a, physx::PxArticulationMotion::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxArticulationMotions];
    std::memcpy(heap, &ret, sizeof PxArticulationMotions);
    return (PxArticulationMotionsPtr) heap;
...
ES PxArticulationMotionsPtr PxArticulationMotionsPtr_operator_Ptr_Tilde_PxArticulationMotion_(physx::PxArticulationMotion::Enum wrp_a){
    auto ret = ::physx::operator~(wrp_a);
    auto heap = new char[sizeof PxArticulationMotions];
    std::memcpy(heap, &ret, sizeof PxArticulationMotions);
    return (PxArticulationMotionsPtr) heap;
...
ES void void_PxArticulationJointPtr_setDriveTypePtr_PxArticulationJointDriveType_(PxArticulationJointPtr wrp_this, physx::PxArticulationJointDriveType::Enum wrp_driveType){
    wrp_this->setDriveType(wrp_driveType);
}

ES physx::PxArticulationJointDriveType::Enum PxArticulationJointDriveType_const_PxArticulationJointPtr_getDriveTypePtr(PxArticulationJointPtr wrp_this){
