...
ES PxTolerancesScalePtr physx_PxTolerancesScalePtr_const_physx_PxPhysics_getTolerancesScale(PxPhysicsPtr wrp_this){
...
ES PxRigidStaticPtr physx_PxRigidStaticPtr_physx_PxPhysics_createRigidStatic_physx_PxTransformPtr_(PxPhysicsPtr wrp_this, PxTransformPtr wrp_pose){
    return (PxRigidStaticPtr) wrp_this->createRigidStatic(*wrp_pose);
}

ES PxRigidDynamicPtr physx_PxRigidDynamicPtr_physx_PxPhysics_createRigidDynamic_physx_PxTransformPtr_(PxPhysicsPtr wrp_this, PxTransformPtr wrp_pose){
...
ES PxPhysicsPtr physx_PxPhysicsPtr_PxCreateBasePhysics_uint_physx_PxFoundationPtr_physx_PxTolerancesScalePtr_bool_(unsigned int wrp_version, PxFoundationPtr wrp_foundation, PxTolerancesScalePtr wrp_scale, bool wrp_trackOutstandingAllocations){
    return (PxPhysicsPtr) PxCreateBasePhysics(wrp_version, *wrp_foundation, *wrp_scale, wrp_trackOutstandingAllocations);
}

ES PxPhysicsPtr physx_PxPhysicsPtr_PxCreateBasePhysics_uint_physx_PxFoundationPtr_physx_PxTolerancesScalePtr_(unsigned int wrp_version, PxFoundationPtr wrp_foundation, PxTolerancesScalePtr wrp_scale){
    return (PxPhysicsPtr) PxCreateBasePhysics(wrp_version, *wrp_foundation, *wrp_scale);
}

ES PxPhysicsPtr physx_PxPhysicsPtr_PxCreatePhysics_uint_physx_PxFoundationPtr_physx_PxTolerancesScalePtr_bool_(unsigned int wrp_version, PxFoundationPtr wrp_foundation, PxTolerancesScalePtr wrp_scale, bool wrp_trackOutstandingAllocations){
    return (PxPhysicsPtr) PxCreatePhysics(wrp_version, *wrp_foundation, *wrp_scale, wrp_trackOutstandingAllocations);
}

ES PxPhysicsPtr physx_PxPhysicsPtr_PxCreatePhysics_uint_physx_PxFoundationPtr_physx_PxTolerancesScalePtr_(unsigned int wrp_version, PxFoundationPtr wrp_foundation, PxTolerancesScalePtr wrp_scale){
