...
ES PxMaterialFlagsPtr PxMaterialFlagsPtr_operator_Ptr_Pipe_PxMaterialFlag_PxMaterialFlag_(physx::PxMaterialFlag::Enum wrp_a, physx::PxMaterialFlag::Enum wrp_b){
...
ES PxMaterialFlagsPtr PxMaterialFlagsPtr_operator_Ptr_Amp_PxMaterialFlag_PxMaterialFlag_(physx::PxMaterialFlag::Enum wrp_a, physx::PxMaterialFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxMaterialFlags];
    std::memcpy(heap, &ret, sizeof PxMaterialFlags);
    return (PxMaterialFlagsPtr) heap;
...
ES PxMaterialFlagsPtr PxMaterialFlagsPtr_operator_Ptr_Tilde_PxMaterialFlag_(physx::PxMaterialFlag::Enum wrp_a){
...
ES void void_PxMaterialPtr_setFlagPtr_PxMaterialFlag_bool_(PxMaterialPtr wrp_this, physx::PxMaterialFlag::Enum wrp_flag, bool wrp__2){
...
ES void void_PxMaterialPtr_setFrictionCombineModePtr_PxCombineMode_(PxMaterialPtr wrp_this, physx::PxCombineMode::Enum wrp_combMode){
    wrp_this->setFrictionCombineMode(wrp_combMode);
}

ES physx::PxCombineMode::Enum PxCombineMode_const_PxMaterialPtr_getFrictionCombineModePtr(PxMaterialPtr wrp_this){
    return (physx::PxCombineMode::Enum) wrp_this->getFrictionCombineMode();
}

ES void void_PxMaterialPtr_setRestitutionCombineModePtr_PxCombineMode_(PxMaterialPtr wrp_this, physx::PxCombineMode::Enum wrp_combMode){
    wrp_this->setRestitutionCombineMode(wrp_combMode);
}

ES physx::PxCombineMode::Enum PxCombineMode_const_PxMaterialPtr_getRestitutionCombineModePtr(PxMaterialPtr wrp_this){
