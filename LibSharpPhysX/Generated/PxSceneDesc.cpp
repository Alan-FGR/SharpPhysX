...
ES PxSceneFlagsPtr PxSceneFlagsPtr_operator_Ptr_Pipe_PxSceneFlag_PxSceneFlag_(physx::PxSceneFlag::Enum wrp_a, physx::PxSceneFlag::Enum wrp_b){
...
ES PxSceneFlagsPtr PxSceneFlagsPtr_operator_Ptr_Amp_PxSceneFlag_PxSceneFlag_(physx::PxSceneFlag::Enum wrp_a, physx::PxSceneFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxSceneFlags];
    std::memcpy(heap, &ret, sizeof PxSceneFlags);
    return (PxSceneFlagsPtr) heap;
...
ES PxSceneFlagsPtr PxSceneFlagsPtr_operator_Ptr_Tilde_PxSceneFlag_(physx::PxSceneFlag::Enum wrp_a){
