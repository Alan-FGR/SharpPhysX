...
ES PxActorFlagsPtr PxActorFlagsPtr_operator_Ptr_Pipe_PxActorFlag_PxActorFlag_(physx::PxActorFlag::Enum wrp_a, physx::PxActorFlag::Enum wrp_b){
...
ES PxActorFlagsPtr PxActorFlagsPtr_operator_Ptr_Amp_PxActorFlag_PxActorFlag_(physx::PxActorFlag::Enum wrp_a, physx::PxActorFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxActorFlags];
    std::memcpy(heap, &ret, sizeof PxActorFlags);
    return (PxActorFlagsPtr) heap;
...
ES PxActorFlagsPtr PxActorFlagsPtr_operator_Ptr_Tilde_PxActorFlag_(physx::PxActorFlag::Enum wrp_a){
...
ES physx::PxActorType::Enum PxActorType_const_PxActorPtr_getTypePtr(PxActorPtr wrp_this){
...
ES void void_PxActorPtr_setActorFlagPtr_PxActorFlag_bool_(PxActorPtr wrp_this, physx::PxActorFlag::Enum wrp_flag, bool wrp_value){
