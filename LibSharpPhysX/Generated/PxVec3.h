...
ES physx::PxVec3 C_PxVec3_PxVec3_2(float nx,float ny,float nz){ // L85

    return physx::PxVec3::PxVec3(nx,ny,nz);
};

ES physx::PxVec3 C_PxVec3_PxVec3_3(physx::PxVec3* v){ // L92
...
ES physx::PxVec3 C_CONST_PxVec3_OP_Minus_2(physx::PxVec3 cls,physx::PxVec3* v){ // L207
