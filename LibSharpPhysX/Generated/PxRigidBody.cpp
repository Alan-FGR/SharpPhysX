...
ES PxRigidBodyFlagsPtr PxRigidBodyFlagsPtr_operator_Ptr_Pipe_PxRigidBodyFlag_PxRigidBodyFlag_(physx::PxRigidBodyFlag::Enum wrp_a, physx::PxRigidBodyFlag::Enum wrp_b){
...
ES PxRigidBodyFlagsPtr PxRigidBodyFlagsPtr_operator_Ptr_Amp_PxRigidBodyFlag_PxRigidBodyFlag_(physx::PxRigidBodyFlag::Enum wrp_a, physx::PxRigidBodyFlag::Enum wrp_b){
    auto ret = ::physx::operator&(wrp_a, wrp_b);
    auto heap = new char[sizeof PxRigidBodyFlags];
    std::memcpy(heap, &ret, sizeof PxRigidBodyFlags);
    return (PxRigidBodyFlagsPtr) heap;
...
ES PxRigidBodyFlagsPtr PxRigidBodyFlagsPtr_operator_Ptr_Tilde_PxRigidBodyFlag_(physx::PxRigidBodyFlag::Enum wrp_a){
...
ES void void_PxRigidBodyPtr_addForcePtr_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_this, physx::PxVec3* wrp_force, physx::PxForceMode::Enum wrp_mode, bool wrp_autowake){
    wrp_this->addForce(*wrp_force, wrp_mode, wrp_autowake);
}

ES void void_PxRigidBodyPtr_addTorquePtr_PxVec3_PxForceMode_bool_(PxRigidBodyPtr wrp_this, physx::PxVec3* wrp_torque, physx::PxForceMode::Enum wrp_mode, bool wrp_autowake){
    wrp_this->addTorque(*wrp_torque, wrp_mode, wrp_autowake);
}

ES void void_PxRigidBodyPtr_clearForcePtr_PxForceMode_(PxRigidBodyPtr wrp_this, physx::PxForceMode::Enum wrp_mode){
    wrp_this->clearForce(wrp_mode);
}

ES void void_PxRigidBodyPtr_clearTorquePtr_PxForceMode_(PxRigidBodyPtr wrp_this, physx::PxForceMode::Enum wrp_mode){
    wrp_this->clearTorque(wrp_mode);
}

ES void void_PxRigidBodyPtr_setForceAndTorquePtr_PxVec3_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_this, physx::PxVec3* wrp_force, physx::PxVec3* wrp_torque, physx::PxForceMode::Enum wrp_mode){
    wrp_this->setForceAndTorque(*wrp_force, *wrp_torque, wrp_mode);
}

ES void void_PxRigidBodyPtr_setRigidBodyFlagPtr_PxRigidBodyFlag_bool_(PxRigidBodyPtr wrp_this, physx::PxRigidBodyFlag::Enum wrp_flag, bool wrp_value){
...
ES void void_PxRigidBodyPtr_addForcePtr_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_this, physx::PxVec3* wrp_force, physx::PxForceMode::Enum wrp_mode){
...
ES void void_PxRigidBodyPtr_addTorquePtr_PxVec3_PxForceMode_(PxRigidBodyPtr wrp_this, physx::PxVec3* wrp_torque, physx::PxForceMode::Enum wrp_mode){
